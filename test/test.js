...
describe("Home page test",function(){
  ...
  // #1 should return 200 for homepage
...
describe("Search director name API test - no match test",function(){


  it("should return true",function(done){

    // calling earch director api
    request
    .get("/api/director?name=kkk")
    .type('json')
    ...
    .end(function(err, res){
    	res.status.should.equal(200);
    	assert.deepEqual(res.body.directors, [])
    	done();
    });
  });
});
...
describe("Search director name API test - unique director",function(){
  ...
  it("should return true",function(done){
    ...
    .end(function(err, res){
    	res.status.should.equal(200);
    	assert.deepEqual(res.body.directors, [ 'mark j. kunerth', 'mark decena', 'mark waters' ])
    	done();
    });
  });
});
  ...
  it("should return true",function(done){
    ...
    .end(function(err, res){
    	...
    	assert.deepEqual(res.body.data, 
    		[{"director":"mark j. kunerth","title":"about a boy","location":"crissy field","lat":37.8049553,"lng":-122.4548624},
    		{"director":"mark j. kunerth","title":"about a boy","location":"powell from bush and sutter","lat":37.7749295,"lng":-122.4194155},
    		{"director":"mark j. kunerth","title":"about a boy","location":"broderick from fulton to mcalister","lat":37.7749295,"lng":-122.4194155},
    		{"director":"mark decena","title":"dopamine","location":"south park (between 2nd and 3rd streets, brannan and bryant streets)","lat":37.7734187,"lng":-122.405858},
    		{"director":"mark decena","title":"dopamine","location":"fort point (presidio, golden gate national recreation area)","lat":37.7749295,"lng":-122.4194155},
    		{"director":"mark waters","title":"just like heaven","location":null,"lat":37.7749295,"lng":-122.4194155}])
    	done();
    });
  });
});
...
describe("Search director name API test - unique movie name",function(){
